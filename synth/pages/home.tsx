  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center h-full">
        {/* title container */}
        <div className="flex justify-between w-5/6 pt-16 pb-16 h-14 ">
        ...
        <section className="flex flex-col items-center justify-center justify-around w-5/6 rounded-lg h-96 bg-slate-700 ">
        ...
        <section className="flex flex-col justify-between w-5/6 h-screen ">
